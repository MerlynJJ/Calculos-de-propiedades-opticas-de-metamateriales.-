...
\begin{abstract}
  ...
  theory for the calculation of its macroscopic permittivity in binary
  systems or with more components, in the non-delayed case and in the
  general case, and we present its implementation in a computational
  package and its use. We end by discussing some applications of it
  for the design of optimized nanostructured optical devices and we
