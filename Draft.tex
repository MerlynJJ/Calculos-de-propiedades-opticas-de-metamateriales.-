...
La descripción de los fenómenos electromagnéticos es provista por las
...
es y $\omega$ la frecuencia de la perturbación, en el espació real
...
que se realiza la medición, se les clasifica como anisótropos
iinhomogéneas.
...
\begin{figure}
  ...
  \caption{(a) Medio homogéneo con permitividad constante $\epsilon$,
    (b) relaciones de dispersión de la propagación de la onda, línea
...
fluctuaciones mucho menor a la longitud de onda. Convenientemente se
...
\begin{equation}
  ...
  \end{array}
\end{equation}
y conmutan con $\hat{P}_{f}$ y $\hat{P}_{p}$.

Al proyectar $\hat{\mathcal{W}}^{-1}=
\left[(\hat{\epsilon}_{ff}-\frac{c^{2}}{\omega^{2}}(\nabla \times
  \nabla \times)_{ff})\right]^{-1}$ en los subespacios longitudinal y
transversal
