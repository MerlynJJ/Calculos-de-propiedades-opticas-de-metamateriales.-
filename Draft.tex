...
Como último ejemplo de la misma respuesta en las cargas electricas de
un sistema. Considerese una esfera metálica la cual es perturbada al
desplazar todos sus electrones en la dirección $\vec{\zeta}$ lo cual
induce una polaricación $\vec{\mathcal{P}}$ en la misma y un campo
...
Por otro lado, un ejemplo de la mejora de propiedades de materiales al
"combinarlos" es la estabilidad de la pigmentación de los vidrios de
la C. de Canterbury cuya construcción data en el siglo XII que bajo la interacción con la luz, altas
temperaturas y diferentes ambientes se deterioran.
